...
public class MainActivity extends AppCompatActivity
{
    ...
    Button createDBButton, addContactButton, deleteContactButton, getContactsButton,
            deleteDBButton, updateContactButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateContactButton = (Button)findViewById(R.id.updateContact);
    ...
    public void upDateContact(View view)
    {
        ...
        try
        {
            contactsDB.execSQL("INSERT INTO contacts (name, email,id) VALUES ('" +
                    contactName + "', '" + contactEmail + "','"+id+ "');");
        }
        catch (Exception ex)
        {
